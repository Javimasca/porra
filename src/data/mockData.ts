...
export const knockoutMatches: Match[] = [
  ...
  knockoutMatch('m77', 'Ronda de 32', '2026-06-30', 'Dallas', '1I', '3C/D/F/G/H'),
  knockoutMatch('m78', 'Ronda de 32', '2026-06-30', 'New York/New Jersey', '2E', '2I'),
  ...
  knockoutMatch('m81', 'Ronda de 32', '2026-07-01', 'Seattle', '1D', '3B/E/F/I/J'),
  knockoutMatch('m82', 'Ronda de 32', '2026-07-01', 'San Francisco Bay Area', '1G', '3A/E/H/I/J'),
  knockoutMatch('m83', 'Ronda de 32', '2026-07-02', 'Los Angeles', '2K', '2L'),
  knockoutMatch('m84', 'Ronda de 32', '2026-07-02', 'Toronto', '1H', '2J'),
  knockoutMatch('m85', 'Ronda de 32', '2026-07-02', 'Vancouver', '1B', '3E/F/G/I/J'),
  knockoutMatch('m86', 'Ronda de 32', '2026-07-03', 'Dallas', '1J', '2H'),
  knockoutMatch('m87', 'Ronda de 32', '2026-07-03', 'Miami', '1K', '3D/E/I/J/L'),
  knockoutMatch('m88', 'Ronda de 32', '2026-07-03', 'Kansas City', '2D', '2G'),

  knockoutMatch('m89', 'Octavos', '2026-07-04', 'Philadelphia', 'Ganador M73', 'Ganador M75'),
  knockoutMatch('m90', 'Octavos', '2026-07-04', 'Houston', 'Ganador M74', 'Ganador M77'),
  knockoutMatch('m91', 'Octavos', '2026-07-05', 'New York/New Jersey', 'Ganador M76', 'Ganador M78'),
  ...
  knockoutMatch('m95', 'Octavos', '2026-07-07', 'Atlanta', 'Ganador M86', 'Ganador M88'),
  knockoutMatch('m96', 'Octavos', '2026-07-07', 'Vancouver', 'Ganador M85', 'Ganador M87'),

  knockoutMatch('m97', 'Cuartos', '2026-07-09', 'Boston', 'Ganador M89', 'Ganador M90'),
  knockoutMatch('m98', 'Cuartos', '2026-07-10', 'Los Angeles', 'Ganador M93', 'Ganador M94'),
  knockoutMatch('m99', 'Cuartos', '2026-07-11', 'Miami', 'Ganador M91', 'Ganador M92'),
